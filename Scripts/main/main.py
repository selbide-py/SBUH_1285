...
class sumModal:
    def __enter__(self):
        ...
        # Load Legal Pegasus tokenizer and model
        tokenizer = AutoTokenizer.from_pretrained(
            '/content/gdrive/MyDrive/HF_Models/legalLM/project/fine_tuned_legal_pegasus_model/', local_files_only=True)
